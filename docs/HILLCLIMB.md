...
| 30 | explicit bi-average REMOVED (fwd/bwd choice + merge-average stay) | park -1.9%/-0.03, screen same-bytes/+0.10dB, -9% enc time; 3% selection was mirror-model noise | KEEP removal — joint search would be the real version (v2.1); suite pending |
