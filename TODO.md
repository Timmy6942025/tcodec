...
| D9 | ARM decode ≥60fps@720p / ≥30fps@1080p | ✅ 720p 15/15; 1080p via q37 | Quiet-box best-of-N internal: 720p t4 ≥60fps on ALL 15 clips (12 clean q32 EP + park/parkrun/ducks via STABLAM: 60.1/65.5/60.5); 1080p t4 34–36fps on q37 rung (need 30 ✅), 25–27 on q32. KEY: x264 itself decodes park q32 at 30.1fps best here — tcodec (24–31 contended) is at PARITY with the reference. Landed (all bit-exact, 54/54 + soak + parity + fuzz): O3/mcpu/LTO, persistent v2 cmds, per-frame + flat quant, tail memset, int-MV path, deblock hoist, range refill/divides, parse→recon pipeline, cost scheduler, v2 ENTRY_POINTS (§7.6.1), STABLAM (sita byte-identical). RDOQ-L2 reverted (fires never). Program in docs/D9_PLAN.md |
